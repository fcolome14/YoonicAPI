...
def upgrade() -> None:
    ...
    op.create_table("subs", sa.Column("id", sa.Integer(), autoincrement=True, nullable=False), 
    ...
    op.create_foreign_key("fk_subs_user", "subs", "users", ["user"], ["id"], ondelete="CASCADE")
    op.create_foreign_key("fk_subs_event", "subs", "events", ["event"], ["id"], ondelete="CASCADE")
    pass
