...
def upgrade() -> None:
    op.create_table("events", sa.Column("id", sa.Integer(), autoincrement=True, nullable=False, primary_key=True),
    ...
    op.add_column("events", sa.Column("cost", sa.DOUBLE_PRECISION(), nullable=False, default=0.00))
    op.add_column("events", sa.Column("capacity", sa.Integer(), nullable=False, default=0))
    op.add_column("events", sa.Column("currency", sa.String(), nullable=True, default="EUR"))
    op.add_column("events", sa.Column("isPublic", sa.Boolean(), nullable=False, default=True))
