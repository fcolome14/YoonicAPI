...
class Seed:
    ...
    def add_subcategories(db: Session):
        subcategory_structure = {
            ...
            "cat.3": ["Programming", "AI & Data", "Hardware", "Startups", "Gaming"],
            "cat.4": [
                "Social Media",
                "Photography",
                "Cinema",
        ...
        for cat_code, sub_names in subcategory_structure.items():
            ...
            for index, sub_name in enumerate(sub_names, start=1):
                ...
                subcategory_models.append(
                    models.Subcategories(code=sub_code, name=sub_name, cat=category.id)
                )
    ...
    def add_tags(db: Session):
        ...
        subcategory_map = {
            subcategory.code: subcategory for subcategory in fetched_subcategories
        }
        ...
        for subcat_code, tag_names in tags_structure.items():
            ...
            for index, sub_name in enumerate(tag_names, start=1):
                ...
                tag_models.append(
                    models.Tags(name=sub_name, subcat=subcategory.id, weight=1)
                )
