...
def upgrade() -> None:
    ...
    op.add_column(
        "events_headers", sa.Column("description", sa.String(), nullable=True)
    )
    op.add_column(
        "events_headers", sa.Column("coordinates", sa.String(), nullable=False)
    )
    ...
    op.add_column(
        "events_lines",
        sa.Column("cost", sa.DOUBLE_PRECISION(), nullable=False, default=0.00),
    )
    op.add_column(
        "events_lines", sa.Column("capacity", sa.Integer(), nullable=False, default=0)
    )
    op.add_column(
        "events_lines", sa.Column("currency", sa.String(), nullable=True, default="EUR")
    )
    op.add_column(
        "events_lines",
